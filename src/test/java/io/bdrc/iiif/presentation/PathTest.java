...
public class PathTest {
    ...
    public static void init() throws IOException {
        ...
        CaffeineCache.put(vi, "vi:bdr:V22084_I0890");
    ...
    public void testPathWithVersion() throws ClientProtocolException, IOException {
        ResponseEntity<String> res = this.restTemplate.getForEntity(
                "http://localhost:" + environment.getProperty("local.server.port") + "/2.1.1/v:bdr:V22084_I0890/manifest", String.class);
    ...
    public void testPathNoVersion() throws ClientProtocolException, IOException {
        ResponseEntity<String> res = this.restTemplate
                .getForEntity("http://localhost:" + environment.getProperty("local.server.port") + "/v:bdr:V22084_I0890/manifest", String.class);
        // System.out.println(res.getBody());
        assert (res.getStatusCode().equals(HttpStatus.OK));
    }
}
