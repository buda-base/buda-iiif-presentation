...
public class AuthCheck {
    ...
    @Test
    public void publicResource() throws ClientProtocolException, IOException, IllegalArgumentException, CertificateException, InvalidKeySpecException,
    ...
    @Test
    public void RestrictedResource() throws ClientProtocolException, IOException, IllegalArgumentException, CertificateException,
            InvalidKeySpecException, NoSuchAlgorithmException {
        // with public Token and authorized picture
        HttpClient client1 = HttpClientBuilder.create().build();
        HttpGet get1 = new HttpGet(
                "http://localhost:" + environment.getProperty("local.server.port") + "/2.1.1/v:bdr:V29329_I1KG15042::10-35/manifest");
